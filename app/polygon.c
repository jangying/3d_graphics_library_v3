...
void frame(void)                            /* called to display a frame */
{
 ...
 M_light_polygon_object(app_data->p,0,0,0,alp,bet,gam);
...
{
 app_data=D_data("data/poly_app.dat");

 HW_init_screen("3Dgpl3 - Polygonal model",300,300);
